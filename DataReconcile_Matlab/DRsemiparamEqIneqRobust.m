function reconciled_with_AlphaGramCh = DRsemiparamEqIneqRobust(eqFunc, ineqFunc, msrd_data, error_params, alpha_params, model_params)
    ...
    mu_and_l_res = fsolve(@AlphaSystemToSolve, mu_and_l_start, [], ...
      eqFunc, ineqFunc, msrd_data, error_params, alpha_params, model_params, xNum, n, eqNum, ineqNum);

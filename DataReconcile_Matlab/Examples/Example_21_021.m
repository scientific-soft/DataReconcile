...
% Call the DRnonparamEqIneq function
reconciled_with_Kernels = DRnonparamEqIneq(@eqFunc, @ineqFunc, msrd_data, model_params, prior_vars, bandwidths);

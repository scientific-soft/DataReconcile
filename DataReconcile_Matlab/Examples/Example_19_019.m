...
% Call the DRsemiparamEqIneq function
reconciled_with_AlphaGramCh = DRsemiparamEqIneq(@eqFunc, @ineqFunc, msrd_data, error_params, alpha_params, model_params);

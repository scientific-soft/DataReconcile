...
alpha_params = [0.1; 3.1]; % [As; Ex] for calculMeanAlpha function
...
% Call the DRsemiparamEqRobust function
reconciled_with_AlphaGramCh = DRsemiparamEqRobust(@Func, msrd_data, error_params, alpha_params, true_params);

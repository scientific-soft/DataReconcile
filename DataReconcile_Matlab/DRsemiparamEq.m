function reconciled_with_AlphaGramCh = DRsemiparamEq(Func, msrd_data, error_params, alpha_params, true_params)
    ...
    % согласуемых величин
    l = zeros([length(Func(mean(msrd_data,2), true_params)), 1]);
    ...
    mu_and_l_res = fsolve(@AlphaSystemToSolve, mu_and_l_start, [], ...
      Func, msrd_data, error_params, alpha_params, true_params);

function reconciled_with_Kernels = DRnonparamEqIneqRobust(eqFunc, ineqFunc, msrd_data, model_params, prior_vars, bandwidths)
...
% bandwidths - вектор значений ширины 
    ...
    mu_and_l_est = fsolve(@KernelsSystemToSolve, mu_and_l_start, [], ...
              eqFunc, ineqFunc, msrd_data, model_params, bandwidths, prior_vars, xNum, n, eqNum, ineqNum);

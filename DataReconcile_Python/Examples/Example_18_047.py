...
msrd_data = np.array([
    [0.3, 0.315, 0.295],
    [0.3, 0.315, 0.295]])  # Example measured data
...
# Call the DRsemiparamEqIneq function to reconcile the measured data
reconciled_data = DRsemiparamEqIneq(eqies_model, ineqies_model, msrd_data, error_params, alpha_params, params_)

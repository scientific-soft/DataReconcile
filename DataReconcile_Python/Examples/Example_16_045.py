...
# Call the DRparamEqIneq function to reconcile the measured data
reconciled_data = DRparamEqIneq(eqies_model, ineqies_model, msrd_data, error_params, params_)

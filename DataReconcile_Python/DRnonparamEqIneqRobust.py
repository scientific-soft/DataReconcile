...
def DRnonparamEqIneqRobust(eqies_model, ineqies_model, msrd_data, model_params, prior_vars, bandwidths):
    """
    Reconciles measured data using kernel-based estimation.

    Parameters:
        eqies_model, ineqies_model (function): Function describing dependencies between reconciled quantities.

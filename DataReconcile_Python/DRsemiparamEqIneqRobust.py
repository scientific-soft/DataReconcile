...
#def alpha_system_to_solve(mu_and_l, args):
    """ args=(eqies_model, ineqies_model, msrd_data, error_params, alpha_params, params_)
...
def DRsemiparamEqIneqRobust(eqies_model, ineqies_model, msrd_data, error_params, alpha_params, params_):
    """

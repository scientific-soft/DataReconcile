...
int main() {
    try {
        ...
        msrd_data << 0.9, 1.2, // cols - measurement results of the same quantity
            1.8, 2.3;          // rows - different quantities
        ...
        // Pass the example_depend_func as a parameter to kernel_data_reconcil
        VectorXd reconciled_data = DRnonparamEq(example_depend_func, msrd_data, model_params, prior_vars, bandwidths);

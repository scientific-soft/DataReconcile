...
int main() {
    ...
    // Call the GaussDataReconcileRobust function to reconcile the measured data
    VectorXd reconciled_data = DRparamEqIneqRobust(eqies_model, ineqies_model, msrd_data, error_params, params_);
